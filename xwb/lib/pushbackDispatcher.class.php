...
class pushbackDispatcher{
	...
	function _readProcessData(){
		$query = DB::query('SELECT * FROM '. DB::table('common_cache'). " WHERE `cachekey` IN ('xwb_pushback_processlock', 'xwb_pushback_nexttime', 'xwb_pushback_updatesec')");
		$res = array();
	...
	function _updateProcessLock($force = false){
		if( true == $force ){
			DB::query('REPLACE INTO '. DB::table('common_cache'). " (`cachekey`, `cachevalue`, `dateline`) VALUES ('xwb_pushback_processlock', '{$this->_thistime}', '{$this->_thistime}')");
		}else{
			DB::query('INSERT IGNORE INTO '. DB::table('common_cache'). " (`cachekey`, `cachevalue`, `dateline`) VALUES ('xwb_pushback_processlock', '{$this->_thistime}', '{$this->_thistime}')");
		}
	}
	...
	function _updateNextProcess($nextUpdateSec = null){
		...
		DB::query('REPLACE INTO '. DB::table('common_cache'). " (`cachekey`, `cachevalue`, `dateline`) VALUES  
