...
/**
 * XWB DB MYSQL类
 * @version $Id: xwbDBi.class.php 374 2015-12-13 05:54:41Z chibimiku@TSDM $
 */
class xwbDBi {
	...
	function connect($dbhost, $dbuser, $dbpw, $dbname = '', $pconnect = 0, $halt = TRUE, $dbcharset = '') {
		...
		$link = mysqli_init();
		$link_result = mysqli_real_connect($link, $dbhost, $dbuser, $dbpw);
		...
		if(!$link_result){
			...
			$dbname && mysql_select_db($this->link, $dbname);
		}
