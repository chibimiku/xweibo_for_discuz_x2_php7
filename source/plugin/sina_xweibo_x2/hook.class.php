...
class plugin_sina_xweibo_x2{
	...
	function global_footer(){
		...
		$isModuleAllowXweiboRun = $this->_isModuleAllowXweiboRun();
		$startxweibo = $this->_start_xweibo($isModuleAllowXweiboRun);
...
EOF;
	...
	function _get_unbind_global_usernav_extra1_content(){
		...
		return <<<EOF
			...
			<a href="home.php?mod=spacecp&ac=plugin&id={$this->pluginid}:home_binding" target="_blank"><img style="vertical-align: middle" src="xwb/images/bgimg/sina_bind_btn.png" /></a>
EOF;
	}
	...
	*/
    ...
    function index_top_output(){
		...
		if(!isset($owbUserRs['screen_name_local_encode'])){
			...
			$owbUserRs['screen_name_local'] = tshtmlspecialchars($owbUserRs['screen_name_local']);
		}
...
class singleton_sina_xweibo_x2{
	...
	function &getInstance(){
		static $_i = null;
		if(null == $_i){
			//$_i =& new singleton_sina_xweibo_x2(); //no more using like this in php7. --chibimiku@TSDM.net
	...
	function start_xweibo( $force = false ){
		...
		//初始化插件环境
		//echo "load weibo: $xwb_start_file";
...
class tpl_sina_xweibo_x2{
	...
	function get_login_button(){
		...
		if (!$_G['uid']) {
			...
			return '<a href="xwb.php?m=xwbAuth.login" rel="nofollow" alt="&#19968;&#27493;&#25630;&#23450;"><img src="/images/bgimg/sina_login_btn.png" onerror="this.onerror=null;this.src=\'static/image/common/none.gif\'" class="vm" /></a>';
		}else{
			return '';
		}
	}
	...
	function get_sina_share_link( $msg = '', $pic= '' ){
		...
		return "javascript:void((function(s,d,e,r,l,p,t,z,c,o) {var getimg=document.getElementsByName('tsdmlz')[0].getElementsByTagName('img');if (getimg.length>0){if(getimg[0].class!='zoom'){p=getimg[0].src}} var f='http://service.weibo.com/share/share.php?appkey=". XWB_APP_KEY. "',u=z||d.location,p=['&url=',e(u),'&title=',e(t||d.title),'&ralateUid=',o||'','&sourceUrl=',e(l),'&content=',c||'gb2312','&pic=',e(p||'')].join('');function a(){if(!window.open([f,p].join(''),'mb', ['toolbar=0,status=0,resizable=1,width=440,height=430,left=',(s.width- 440)/2,',top=',(s.height-430)/2].join('')))u.href=[f,p].join('');}; if(/Firefox/.test(navigator.userAgent)){setTimeout(a,0);}else{a();}}) (screen,document,encodeURIComponent,'','','{$pic}','{$msg}','','". CHARSET. "', '{$owId}'));";
	}
